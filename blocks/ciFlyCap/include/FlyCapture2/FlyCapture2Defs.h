...
//=============================================================================
// $Id: FlyCapture2Defs.h,v 1.185 2010/06/30 19:33:28 soowei Exp $
//=============================================================================
...
namespace FlyCapture2
{
    ...
    struct GigEConfig
    {
        /** Number of stream channels. Read only. */
        ...
        {
            numChannels = 0;
            memset( channels, 0x0, 512 * sizeof(GigEStreamChannel) );
        }
    };
    ...
    */
    ...
    struct CameraStats
    {
        /* Number of droppped image in DROP_IMAGE mode */
        unsigned int imageDropped;		
        /* Number of corrupt image, such as missing packet, zero packet */
        unsigned int imageCorrupt;
        /* Number of transmission failed of camera */
        unsigned int imageXmitFailed;	
        /* Number of image dropped in driver */
